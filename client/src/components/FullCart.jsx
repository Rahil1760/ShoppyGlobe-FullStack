...
export const FullCart = ({selector}) => {
    const [total, setTotal] = useState(0);
    // const selector = useCartItemCustom();
    ...
    useEffect(() => {
        ...
        setTotal(totalPrice);
    }, [selector, cartitemAndQuantityCounter]);
    return (
        <div className="h-20 bg-slate-500 flex items-center justify-around mt-5">
            <div>
                <p className="font-bold md:text-xl">Total Count : {total.toString().slice(0, 6)} $</p>
            </div>
            <div>
